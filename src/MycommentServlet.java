...
public class MycommentServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("发来的评论是:" + userid+musicid+content+year+month+day+hour+minute+second);

        int result = -1;
        result = getresult(musicid,userid,content,year,month,day,hour,minute,second);
        if (result == 1){
