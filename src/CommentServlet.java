...
public class CommentServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("查询的歌曲id:" + musicid);
        List<Comment> commentList = new ArrayList<>();
        getcomments(commentList, musicid);
    ...
    public void getcomments(List<Comment> commentList, String musicid){
        ...
        try {
            ...
            String sql = "select * from comment where musicid='"+realmusicid+"'";
