...
public class CoCommentServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("查询的动态id:" + dycommentid);
        List<Comment> commentList = new ArrayList<>();
        getcomments(commentList, dycommentid);
    ...
    public void getcomments(List<Comment> commentList, String dycommentid){
        ...
        try {
            ...
            String sql = "select * from cocomment where commentid='"+realdycommentid+"'";
